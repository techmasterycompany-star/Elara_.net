...
VALUES (N'20260912123709_InitialCreate', N'9.0.0');
...
CREATE TABLE [NewsletterSubscriptions] (
    ...
    CONSTRAINT [FK_NewsletterSubscriptions_Users_UserId1] FOREIGN KEY ([UserId1]) REFERENCES [Users] ([Id])
);
...
CREATE TABLE [Referrals] (
    ...
    CONSTRAINT [FK_Referrals_Users_UserId] FOREIGN KEY ([UserId]) REFERENCES [Users] ([Id])
);
...
CREATE INDEX [IX_NewsletterSubscriptions_UserId1] ON [NewsletterSubscriptions] ([UserId1]);
...
CREATE INDEX [IX_Referrals_UserId] ON [Referrals] ([UserId]);
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260913160029_referralpromocodetables', N'9.0.0');

ALTER TABLE [LoyaltyTransactions] DROP CONSTRAINT [FK_LoyaltyTransactions_Orders_OrderId];

ALTER TABLE [LoyaltyTransactions] DROP CONSTRAINT [FK_LoyaltyTransactions_Users_UserId];

ALTER TABLE [LoyaltyTransactions] DROP CONSTRAINT [PK_LoyaltyTransactions];

EXEC sp_rename N'[LoyaltyTransactions]', N'Transactions', 'OBJECT';

EXEC sp_rename N'[Transactions].[IX_LoyaltyTransactions_UserId]', N'IX_Transactions_UserId', 'INDEX';

EXEC sp_rename N'[Transactions].[IX_LoyaltyTransactions_OrderId]', N'IX_Transactions_OrderId', 'INDEX';
...
ALTER TABLE [Transactions] ADD CONSTRAINT [FK_Transactions_Users_UserId] FOREIGN KEY ([UserId]) REFERENCES [Users] ([Id]);

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260915124246_SeedRoles', N'9.0.0');
...
CREATE INDEX [IX_SellerApplications_UserId] ON [SellerApplications] ([UserId]);

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260917190927_addSellerApplicationsEntity', N'9.0.0');

DROP INDEX [IX_SellerApplications_UserId] ON [SellerApplications];

CREATE UNIQUE INDEX [IX_SellerApplications_UserId] ON [SellerApplications] ([UserId]) WHERE [Status] = 1;

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260918140337_addIndex', N'9.0.0');
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260919184117_addBannerAndHomepageSectionEntites', N'9.0.0');

ALTER TABLE [HomepageSections] ADD [CategoryId] bigint NULL;

CREATE INDEX [IX_HomepageSections_CategoryId] ON [HomepageSections] ([CategoryId]);

ALTER TABLE [HomepageSections] ADD CONSTRAINT [FK_HomepageSections_Categories_CategoryId] FOREIGN KEY ([CategoryId]) REFERENCES [Categories] ([Id]);

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260919192353_updateHomepageSectionEntity', N'9.0.0');
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260920090719_AddWalletAndWalletTransaction', N'9.0.0');

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260920132023_remigratedb', N'9.0.0');
