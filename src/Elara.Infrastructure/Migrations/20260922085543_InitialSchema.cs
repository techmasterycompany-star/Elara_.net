...
namespace Elara.Infrastructure.Migrations
{
    ...
    public partial class InitialSchema : Migration
    {
        ...
        {
<<<<<<< HEAD:src/Elara.Infrastructure/Migrations/20260922085543_InitialSchema.cs
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuestSessionId = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingStreet = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Provider = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    TransactionId = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    Currency = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SellerProfileId = table.Column<long>(type: "bigint", nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payouts_SellerProfiles_SellerProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrackingNumber = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Shipments_SellerProfiles_SellerProfileId",
                        column: x => x.SellerProfileId,
                        principalTable: "SellerProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImagePublicId = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    DisplayOrder = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payouts_SellerProfileId",
                table: "Payouts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipments_SellerProfileId",
                table: "Shipments",
                column: "SellerProfileId");
...
=======
            ...
            //            principalColumn: "Id");
            //        table.ForeignKey(
            //            name: "FK_NewsletterSubscriptions_Users_UserId1",
            //            column: x => x.UserId1,
            //            principalTable: "Users",
            //            principalColumn: "Id");
            //    });
            ...
            //migrationBuilder.CreateIndex(
            //    name: "IX_NewsletterSubscriptions_UserId1",
            //    table: "NewsletterSubscriptions",
            //    column: "UserId1");
            ...
            //    columns: new[] { "UserId", "ProductId" },
            //    unique: true);
>>>>>>> d3f43e20e4e8b39fe9c95d71780f026a50744c83:src/Elara.Infrastructure/Migrations/20260913160029_referralpromocodetables.cs
        }
